...
def plot_tracking(image,
    ...
    blank_im = np.zeros((im_h, im_w, 3), np.uint8)
    ...
    for i, tlwh in enumerate(tlwhs):
        ...
        blank_im[intbox[1] : intbox[3], intbox[0] : intbox[2]] =  im[intbox[1] : intbox[3], intbox[0] : intbox[2]]
    im = blank_im
        # cv2.rectangle(
    ...
    for cls_id in range(num_classes):
        ...
        for i, tlwh in enumerate(tlwhs):
            ...
            color = get_color(abs(obj_id)) if in_region == False else (0, 0,
                                                                       255)
            blank_image[intbox[1] : intbox[3], intbox[0] : intbox[2]] =  im[intbox[1] : intbox[3], intbox[0] : intbox[2]]
        im = blank_image
        #     cv2.rectangle(
        #         im,
        #         intbox[0:2],
